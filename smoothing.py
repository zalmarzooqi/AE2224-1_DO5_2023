                ...
                if file[-4:] == ".csv":
                    ...
                    for j in range(data.shape[0]):
                        ...
                        if file_timesteps[-1] >= 74000:
                            break
                    # Smooth data
                    smooth_abs = data_smoothing(file_matrix_abs)
...
# Data folder is the output of ROI sorting (+case folder, eg "1_Uninhibited")
data_folder = r""
# Output folder is where the plots are saved
output_folder = r""
cases = ["1_Uninhibited"]

coc_plotting(data_folder, output_folder, cases)
