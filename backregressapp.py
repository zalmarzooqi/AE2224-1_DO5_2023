...
t_start, k1, y_inter1, model_listk1 = Backward_regression.slope_k1(file_matrix_abs_smooth,file_timesteps,file_matrix_abs_smooth_list)
t_start, k2, y_inter2, model_listk2 = Backward_regression.slope_k2(file_matrix_abs_smooth,file_timesteps,file_matrix_abs_smooth_list)
t_star, val_star = Backward_regression.intersect(k1,y_inter1,k2,y_inter2,file_matrix_abs_smooth_list,file_timesteps)